...
Each entry includes a timestamp, the decision made, the alternatives considered, the rationale for the choice, and the outcome (filled in after the fact).

## Decisions

---

(Entries will be appended during operations. Example format below.)
